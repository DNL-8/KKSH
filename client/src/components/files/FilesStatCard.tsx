...
export function FilesStatCard({ label, value, subtext, icon }: FilesStatCardProps) {
    return (
        <div className="group relative overflow-hidden rounded-2xl border border-white/5 bg-slate-900/40 backdrop-blur-md p-4 transition-all duration-300 hover:bg-white/[0.03] hover:border-[hsl(var(--accent)/0.3)] hover:shadow-[0_0_24px_rgba(var(--glow),0.1)]">
