...
export function SettingsSidebar({ preferences, updatePreference }: SettingsSidebarProps) {
    ...
    return (
        <div className="sticky top-24 space-y-6">
            <div className={`rounded-[40px] p-8 ${isIosTheme ? "ios26-section" : "border border-slate-700/40 bg-gradient-to-b from-[#0a0f1d]/90 to-[#050813]/90 shadow-[0_20px_50px_rgba(0,0,0,0.5)] backdrop-blur-xl"}`}>
                ...
                <div className="flex flex-col gap-3">
                    <button
                        ...
                        className={`rounded-[20px] p-5 border transition-all text-left group ${preferences.difficulty === "casual"
                            ...
                            : isIosTheme ? "ios26-chip ios26-focusable opacity-90" : "bg-white/[0.02] border-slate-700/40  opacity-60 grayscale hover:grayscale-0 hover:opacity-100 hover:bg-white/[0.05]"
                            }`}
                    >
                    ...
                    <button
                        ...
                        className={`rounded-[20px] p-5 border transition-all text-left relative overflow-hidden group ${preferences.difficulty === "hardcore"
                            ...
                            : isIosTheme ? "ios26-chip ios26-focusable opacity-90" : "bg-white/[0.02] border-slate-700/40 hover:bg-red-950/20 hover:border-red-500/30 opacity-80 hover:opacity-100"
                            }`}
                    >
            ...
            <div data-testid="settings-theme-section" className={`rounded-[40px] p-8 ${isIosTheme ? "ios26-section" : "border border-slate-700/40 bg-gradient-to-b from-[#0a0f1d]/90 to-[#050813]/90 shadow-[0_20px_50px_rgba(0,0,0,0.5)] backdrop-blur-xl"}`}>
            ...
            <div className={`rounded-[40px] p-10 text-center group ${isIosTheme ? "ios26-section-hero" : "bg-gradient-to-b from-[#0a0f1d]/90 to-[#03050a]/95 border border-slate-700/40 shadow-[0_20px_50px_rgba(0,0,0,0.6)] backdrop-blur-xl"}`}>
