    ...
    return (
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
            <div className="space-y-4">
                ...
                <div className="h-8 w-full overflow-hidden rounded-3xl border border-red-950/50 liquid-glass shadow-[inset_0_5px_15px_rgba(0,0,0,0.8)] ring-2 ring-red-950/30 backdrop-blur-sm p-1">
                    <div
            ...
            <div className="space-y-4">
                ...
                <div className="h-8 w-full overflow-hidden rounded-3xl border border-cyan-950/50 liquid-glass shadow-[inset_0_5px_15px_rgba(0,0,0,0.8)] ring-2 ring-cyan-950/30 backdrop-blur-sm p-1">
                    <div
