  ...
  return (
    <div className={`space-y-6 pb-20 ${isLoaded ? "animate-in fade-in duration-500" : "opacity-0"} ${isIosTheme ? "ios26-text-secondary" : ""}`}>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-12">
        <section
          ...
          className={`lg:col-span-4 rounded-3xl p-6 relative overflow-hidden group ${isIosTheme
            ...
            : "border border-slate-700/40 bg-gradient-to-b from-[#0a0f1d]/90 to-[#050813]/95 backdrop-blur-xl shadow-[0_10px_40px_rgba(0,0,0,0.5)]"
            }`}
        >
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className={`rounded-full p-1.5 transition-colors ${isIosTheme
                  ...
                  : "border border-slate-700/40 text-slate-400 hover:text-slate-200 hover:bg-white/[0.10]"
                  }`}
              >
                <Icon name="settings" />
              </button>
              {authUser && (
                <button
                  ...
                  className={`rounded-full p-1.5 transition-colors ${isIosTheme
                    ? "ios26-control ios26-focusable text-slate-700 hover:text-slate-900"
                    : "border border-slate-700/40 text-slate-400 hover:text-cyan-300 hover:bg-cyan-500/10"
                    }`}
                >
          ...
          <div className="space-y-5 rounded-2xl border border-slate-700/40 liquid-glass-inner p-5 shadow-[inset_0_0_30px_rgba(0,0,0,0.8)] relative z-10">
        ...
        <section
          ...
          className={`lg:col-span-8 rounded-3xl p-8 relative overflow-hidden transition-all duration-700 ${isIosTheme
            ...
            : `border border-slate-700/40 bg-gradient-to-br from-[#02050a]/95 to-[#050101]/95 backdrop-blur-2xl ${activeQuest ? "shadow-[0_0_50px_rgba(220,38,38,0.1)]" : "shadow-[0_0_50px_rgba(34,211,238,0.05)]"}`
            }`}
        >
          ...
          <div className="relative z-10">
            ...
            <div className="mb-4 flex items-center gap-3 text-[11px] font-bold uppercase tracking-widest text-slate-600">
              <span className="text-slate-300">Rank {(activeQuest?.rank ?? "F").toUpperCase()}</span>
            ...
            <div className="mt-8 flex flex-wrap gap-4">
              <div className="flex items-center gap-3 rounded-xl border border-slate-700/40 bg-white/[0.02] px-4 py-3 text-sm text-blue-300 backdrop-blur-sm shadow-[inset_0_1px_1px_rgba(255,255,255,0.05)]">
              ...
              <div className="flex items-center gap-3 rounded-xl border border-slate-700/40 bg-white/[0.02] px-4 py-3 text-sm text-red-300 backdrop-blur-sm shadow-[inset_0_1px_1px_rgba(255,255,255,0.05)]">
              ...
              <div className="flex items-center gap-3 rounded-xl border border-slate-700/40 bg-white/[0.02] px-4 py-3 text-sm text-purple-300 backdrop-blur-sm shadow-[inset_0_1px_1px_rgba(255,255,255,0.05)]">
            ...
            <div className="mt-10">
              ...
              <div className="h-3 overflow-hidden rounded-full border border-slate-700/40 liquid-glass shadow-[inset_0_2px_5px_rgba(0,0,0,0.8)] relative">
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
        ...
        <SystemCard icon="chart-histogram" tone="purple" title="Status Evolucao" value={`Streak: ${streakDays}`} sub={`Nivel ${level} - ${weekPercent}% Semana`} valueTestId="hub-system-evolution-value" footer={<div className="mt-3 border-t border-slate-700/40 pt-3 text-[10px] font-black uppercase tracking-wider text-purple-400">Maestria I</div>} />
      </div>
    </div>
  );
}
