    ...
    <div className="mx-auto max-w-7xl space-y-8 p-4 md:p-6 lg:p-8">
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-12">
        <div className="space-y-6 lg:col-span-8">
          ...
          <section className="evo-slide-up rounded-[32px] border border-white/20 liquid-glass p-8 xl:p-10 shadow-[0_20px_50px_rgba(0,0,0,0.3)]">
          ...
          <section className="evo-slide-up relative min-h-[310px] rounded-[32px] border border-white/20 liquid-glass p-1.5 shadow-[0_20px_50px_rgba(0,0,0,0.3)]">
            ...
            <div className="relative h-full overflow-hidden rounded-[26px] liquid-glass-inner">
